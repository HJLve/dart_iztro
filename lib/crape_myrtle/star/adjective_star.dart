...
/// @returns 38杂耀
List<List<FunctionalStar>> getAdjectiveStar(String solarDateStr, int timeIndex,
    [bool? fixLeap]) {
  final stars = initStars();
  final yearly = getHeavenlyStemAndEarthlyBranchSolarDate(
          solarDateStr, timeIndex, getConfig().yearDivide)
      .yearly;
  final yearlyIndex = getYearlyStarIndex(solarDateStr, timeIndex);
  final monthlyIndex = getMonthlyStarIndex(solarDateStr, timeIndex);
  ...
  stars[hongLuanIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('hongLuan'),
      type: StarType.flower,
      scope: Scope.origin)));
  stars[tianXiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianXi'),
      type: StarType.flower,
      scope: Scope.origin)));
  stars[tianYaoIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianYao'),
      type: StarType.flower,
      scope: Scope.origin)));
  stars[xianChiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('xianChi'),
      type: StarType.flower,
      scope: Scope.origin)));
  stars[yueJieIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('jieShen'),
      type: StarType.helper,
      scope: Scope.origin)));
  stars[sanTaiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('sanTai'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[baZuoIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('baZuo'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[enguangIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('engGuang'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianGuiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianGui'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[longChiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('longChi'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[fenGeIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('fengGe'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianCaiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianCai'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianShouIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianShou'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[taiFuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('taiFu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[fenggaoIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('fengGao'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianWuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianWu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[huaGaiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('huaGai'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianGuanIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianGuan'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianFuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianFu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianChuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianChu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianYueIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianYue'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianDeIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianDe'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[yueDeIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('yueDe'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianKongIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianKong'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[xunKongIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('xunKong'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[jieLuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('jieLu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[kongWangIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('kongWang'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[guChenIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('guChen'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[guaSuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('guaSu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[feiLianIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('feiLian'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[poSuiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('poSui'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianXingIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianXing'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[yinShaIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('yinSha'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianKuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianKu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianXuIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianXu'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianShiIndex].add(FunctionalStar(Star(
      name: getStarNameFrom('tianShi'),
      type: StarType.adjective,
      scope: Scope.origin)));
  stars[tianShangIndex].add(FunctionalStar(Star(
