...
- คำนวณวันที่ตามปฏิทินจันทรคติจากวันที่ตามปฏิทินสุริยคติ
- คำนวณข้อมูลแปดอักษร (BaZi)
- คำนวณข้อมูลแผนภูมิโหราศาสตร์จื้อเหวย
- ให้ข้อมูลโดยละเอียดสำหรับแต่ละตำแหน่งในแผนภูมิ
- คำนวณเวลาสุริยะจริงอย่างแม่นยำ (ตามหลักดาราศาสตร์)
- สืบค้นตำแหน่งภูมิศาสตร์และข้อมูลละติจูด/ลองจิจูด
- รองรับหลายแพลตฟอร์ม: Android, iOS, macOS, Windows และ Web
